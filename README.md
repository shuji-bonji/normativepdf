...
| Round-trip (read → write → read), all three output forms | **2882/2882** with an equal object graph — classic table, cross-reference stream, and object streams |
| `qpdf --check`, source vs rewrite | **2882/2882 introduce no complaint the source did not already have**, in all three forms |
